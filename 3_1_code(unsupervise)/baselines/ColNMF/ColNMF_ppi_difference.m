function [ output_args ] = ColNMF_ppi_difference( input_args )
%COLNMF_PPI_DIFFERENCE Summary of this function goes here
%   Detailed explanation goes here
    ...
    name_prefix = ['ColNMF_' species_acronym '_result_ppi'];
    count =0;
    ...
    load(file_name_cell{1,1},'ColNMF_result_cell');
    learned_matrix_cell = ColNMF_result_cell{2,1};
    best_parameter_array = ColNMF_result_cell{3,1};
    ...
    ColNMF_result_cell = {evaluation_test};
    %%%%%%%% save result %%%%%%%%
    result_file_name = ['ColNMF_' species_acronym '_result_ppi_difference_' datestr(now,30) '.mat' ];  
    save(result_file_name,'ColNMF_result_cell');
    %%%%%%%% save result %%%%%%%%
    rmpath(data_dir);
    rmpath(tool_dir);
