function [ output_args ] = ColNMF(parameter_cell, data_file_cell)
    %%%%%%%%%%%%%%%%%%%%%parse parameter%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    load(g_p_network_file ,'g_p_network_first','g_p_network_second','M','gene_id');      
    ...
    ColNMF_result_cell = {evaluation_test;learned_matrix_cell;best_parameter_array;evaluation_result;max_ites;alpha_set;beta_set};
    toc;
     %%%%%%%%%%%%%test%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
