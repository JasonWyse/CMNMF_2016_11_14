function [learned_matrix_cell] =  ColNMF_Train(train_parameter_cell, matrix_cell_train, initial_matrix_cell)
    ...
    lambda1 = 0;
    lambda2 = 0;
    [L,W_out,H1_out,H2_out] =  ColNMF_LF(max_ites,V1,V2,W,H1,H2,M,alpha,beta,lambda1,lambda2);
