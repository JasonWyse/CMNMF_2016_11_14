function [ output_args ] = HNMF( parameter_cell,data_file_cell )
    ...
    HNMF_result_cell = {evaluation_test;learned_matrix_cell;best_parameter_array;evaluation_result;max_ites;alpha_set;beta_set};
    toc;
     %%%%%%%%%%%%%test%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
